"""
Stealth browser manager for Google Maps scraping.

Reuses the same pattern as uae-realestate — Playwright with stealth,
session persistence, headless-first with headed fallback.
"""
...
class StealthBrowser:
    ...
    async def new_context(
        ...
        Args:
            ...
            session_name: Session file name for cookie persistence
            geolocation: {"latitude": float, "longitude": float} or None
            timezone_id: IANA timezone (e.g. "America/New_York") or empty
        """
